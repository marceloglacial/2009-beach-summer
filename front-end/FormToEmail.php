...
$my_email = "marcelo@verdesmares.com.br";
...
$from_email = "pvm@verdesmares.com.br";
...
if(substr_count($_REQUEST['email'],"@") != 1 || stristr($_REQUEST['email']," ")){$errors[] = "Email invalido";}else{$exploded_email = explode("@",$_REQUEST['email']);if(empty($exploded_email[0]) || strlen($exploded_email[0]) > 64 || empty($exploded_email[1])){$errors[] = "Email address is invalid";}else{if(substr_count($exploded_email[1],".") == 0){$errors[] = "Email address is invalid";}else{$exploded_domain = explode(".",$exploded_email[1]);if(in_array("",$exploded_domain)){$errors[] = "Email address is invalid";}else{foreach($exploded_domain as $value){if(strlen($value) > 63 || !preg_match('/^[a-z0-9-]+$/i',$value)){$errors[] = "Email address is invalid"; break;}}}}}}
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Obrigado.";

$message = stripslashes($message);

$subject = "Beach Summer: Fale Conosco";
...
<title>Beach Summer - Fale Conosco</title>
...
<div id="Site">
  <!-- CABECALHO -->
  <div id="Cabecalho">
    <h1><a href="/">Rádio Tamoio</a></h1>
  </div>
  <!-- FIM DE CABECALHO -->
  <!-- CONTATO -->
  <div id="Contato">
<b>Obrigado <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?></b>
<br>Sua mensagem foi enviada com sucesso.
<p><a href="<?php print $continue; ?>">Clique aqui para voltar.</a></p>
